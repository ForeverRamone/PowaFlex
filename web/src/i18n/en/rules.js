...
export default {
  ...
  'Pedir notas a MDBList': 'Fetch scores from MDBList',
  'Pide ahora a MDBList la nota de las candidatas que aún no la tienen': 'Ask MDBList right now for the score of the candidates that still lack one',
  'Sin clave de MDBList no hay nota Σ': 'Without an MDBList key there is no Σ score',
  'Nada que pedir: todas las candidatas tienen ya su nota, o MDBList aún no la calcula': 'Nothing to fetch: every candidate already has its score, or MDBList has not computed it yet',
  '{n} notas nuevas de {p} pedidas': '{n} new scores out of {p} requested',

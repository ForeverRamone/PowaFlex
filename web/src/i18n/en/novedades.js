...
export default {
  // ── Beta 1.22 ──────────────────────────────────────────────────────────────
  'Las fichas que no cuadraban en Criterion, y las esperas que ya dicen cuánto llevan':
    'The Criterion entries that did not line up, and progress bars that now say how long they have been going',
  'Varias fichas de los cánones nuevos no cuadraban con su película, y la causa no era la que parecía: TMDB guarda a John Woo con su nombre en mandarín, «Wu Yu-Sheng», y «John Woo» vive solo entre sus alias. Como la comprobación exige que el nombre de quien dirige coincida, «The Killer», «Hard Boiled» y «Last Hurrah for Chivalry» se quedaban sin ficha teniéndola delante. Ahora, cuando todo lo demás falla, se miran también los alias — sin aflojar la regla de oro: el título tiene que clavar igualmente.':
    'Several entries in the new canons did not line up with their film, and the cause was not the obvious one: TMDB stores John Woo under his Mandarin name, “Wu Yu-Sheng”, and “John Woo” lives only among his aliases. Since the check requires the director’s name to match, “The Killer”, “Hard Boiled” and “Last Hurrah for Chivalry” were left with no entry while it sat right there. Now, once everything else has failed, the aliases are checked too — without loosening the golden rule: the title still has to match exactly.',
  'Otras cinco no eran películas. Criterion edita también miniseries —«Fishing with John», «Tanner ’88», «The Underground Railroad»—, y ahí no había nada que emparejar: no tienen ficha de película en TMDB ni la van a tener. Antes dejaban un hueco mudo que parecía un fallo; ahora la aplicación lo pregunta y lo dice. En el catálogo de Criterion, de quince fichas sin casar a ocho.':
    'Another five are not films at all. Criterion also releases miniseries — “Fishing with John”, “Tanner ’88”, “The Underground Railroad” — and there was nothing there to match: they have no movie entry on TMDB and never will. They used to leave a silent gap that looked like a bug; the app now asks and says so. Across the Criterion collection, from fifteen unmatched entries down to eight.',
  'Las ocho que quedan son erratas de la propia Wikipedia («Harikari» por Harakiri, «The Wages for Fear», «Berlin Alexanderplantz») y un dato mal puesto: «The Flight of the Phoenix» aparece atribuida a Robert Altman y la dirigió Robert Aldrich. Para eso está el ✎ de cada ficha, que recuerda tu corrección para siempre.':
    'The eight that remain are Wikipedia’s own typos (“Harikari” for Harakiri, “The Wages for Fear”, “Berlin Alexanderplantz”) plus one wrong credit: “The Flight of the Phoenix” is attributed to Robert Altman and was directed by Robert Aldrich. That is what the ✎ on every entry is for — it remembers your correction for good.',
  'Las esperas dicen ya cuánto llevan. La rueda que gira solo estaba en las barras sin porcentaje, pero un porcentaje puede quedarse clavado media espera —las cuatro consultas del Dashboard salen a la vez y vuelven a la vez— y una barra vacía e inmóvil es justo lo que hace pensar que se ha colgado. Ahora la rueda y el reloj están en las dos, a los doce segundos se explica por qué no hay porcentaje, y el 100 % ya no dice «Listo» mientras todavía queda ordenar y pintar.':
    'Waits now say how long they have been going. The spinner was only on bars with no percentage, but a percentage can sit still for half the wait — the Dashboard’s four queries all leave together and come back together — and an empty, motionless bar is exactly what makes you think it has hung. The spinner and the clock are now on both, after twelve seconds it explains why there is no percentage, and 100 % no longer says “Done” while there is still sorting and drawing to do.',
  'Y una barra ya no enseña el progreso de otra tarea. El servidor tiene una sola casilla de progreso para doce trabajos distintos, así que si el pase nocturno estaba traduciendo títulos cuando abrías Cine venidero, lo que veías debajo del rótulo del calendario era el pase nocturno. Ahora cada espera puede pedir la suya, y cuando no puede, la barra dice de qué tarea sale el número.':
    'And a bar no longer shows another task’s progress. The server has a single progress slot for twelve different jobs, so if the nightly pass was translating titles when you opened Upcoming cinema, what you saw under the calendar heading was the nightly pass. Each wait can now ask for its own, and when it cannot, the bar says which task the number comes from.',
  'Biblioteca, Listas y Favoritos se repintaban enteras con cualquier cambio. Con 780 tarjetas cargadas, cada tecla en la caja de buscar costaba 35 ms; una lista de MDBList de cinco mil títulos ponía 21.257 elementos en pantalla para enseñar doce filas; y marcar una casilla en Favoritos con 600 personas seguidas repintaba las 600. Las tres van ya por partes.':
    'Library, Lists and Favorites redrew in full on any change. With 780 cards loaded, every keystroke in the search box cost 35 ms; a 5,000-title MDBList list put 21,257 elements on screen to show twelve rows; and ticking one checkbox in Favorites with 600 people followed redrew all 600. All three now work in parts.',
  'El motor de React se bajaba otra vez con cada actualización de la aplicación: por un nombre mal puesto en el troceado del empaquetado, sus 264 KB viajaban pegados al código de la app en vez de ir aparte. Ahora se reaprovecha entre versiones.':
    'React’s engine was downloaded again with every app update: because of a wrong name in the bundle splitting, its 264 KB travelled glued to the app’s own code instead of on its own. It is now reused across versions.',
  'Salud de los datos abre con un resumen —«2 de 5 auditorías tienen algo que revisar»— y un atajo a cada una, en vez de seis bloques seguidos sin jerarquía en los que había que bajar hasta el final para saber si pasaba algo.':
    'Data health now opens with a summary — “2 of 5 audits have something to review” — and a shortcut to each one, instead of six equal blocks in a row where you had to scroll to the end to find out whether anything was wrong.',
  'Y en el móvil, los objetivos que se quedaban pequeños para el pulgar: las pestañas de oficio de Personas estaban en 28 píxeles de alto y la ★ de seguir era el objetivo más pequeño de su página. Los botones de la casa suben a 40 y la estrella crece de caja sin crecer de icono.':
    'And on mobile, the targets that were too small for a thumb: the role tabs on People were 28 pixels tall and the ★ follow button was the smallest target on its page. House buttons go up to 40 and the star grows its box without growing its icon.',

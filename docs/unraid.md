# PowaFlex en UNRAID (Docker)

PowaFlex no necesita plantilla de Community Applications: se añade en un minuto como
...
4. **Add another Path, Port, Variable…** → **Path**:
   - Container Path: `/data`
   - Host Path: `/mnt/user/appdata/powaflex`

/**
 * La encuesta de la crítica de Sight & Sound 2022 («The Greatest Films of All
 * Time»), lista extendida con empates: 1.639 votantes, se renueva cada década
 * (la próxima, 2032). Extraída del estado embebido de la página oficial del
 * BFI (bfi.org.uk/sight-and-sound/greatest-films-all-time) el 2026-08-03:
 * dataset FIJO, cero mantenimiento — como los cánones de TSPDT.
 */
export const SIGHT_AND_SOUND_2022 = [
  {
    "rank": 1,
    "tied": false,
